...
const clerkAppearance = {
  ...
  elements: {
    ...
    cardBox:
      "bg-card border-4 border-primary rounded-none shadow-[4px_4px_0px_0px_hsl(var(--primary))] w-[440px] max-w-full overflow-hidden",
    card: "!shadow-none !border-0 !bg-transparent !rounded-none",
    footer:
      "!shadow-none !border-0 !bg-transparent !rounded-none bg-muted/30 border-t-4 border-border",
    ...
    formButtonPrimary:
      "bg-primary text-primary-foreground font-bold uppercase rounded-none border-0 hover:bg-primary/90 transition-none",
    formFieldInput:
      "bg-background border-4 border-border rounded-none focus:ring-0 focus:border-primary font-mono text-sm",
  },
};
      ...
      <QueryClientProvider client={queryClient}>
        ...
        <RoutedErrorBoundary>
          <Switch>
            ...
            <Route path="/island/hotel">
              <ProtectedRoute component={IslandHotelPage} />
            </Route>
