...
export const getDelegateFromTalkUrl = (agentId: string,) => {




  return `/api/agents/${agentId}/delegate-from-talk`
}

/**
 * @summary Queue a confirmed task from one agent to an authorized teammate
 */
export const delegateFromTalk = async (agentId: string,
    talkDelegationInput: TalkDelegationInput, options?: Parameters<typeof customFetch>[1]): Promise<Task> => {

  return customFetch<Task>(getDelegateFromTalkUrl(agentId),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(talkDelegationInput)
  }
);}
...
export const getDelegateFromTalkMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof delegateFromTalk>>, TError,{agentId: string;data: BodyType<TalkDelegationInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof delegateFromTalk>>, TError,{agentId: string;data: BodyType<TalkDelegationInput>}, TContext> => {

const mutationKey = ['delegateFromTalk'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof delegateFromTalk>>, {agentId: string;data: BodyType<TalkDelegationInput>}> = (props) => {
          const {agentId,data} = props ?? {};

          return  delegateFromTalk(agentId,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DelegateFromTalkMutationResult = NonNullable<Awaited<ReturnType<typeof delegateFromTalk>>>
    export type DelegateFromTalkMutationBody = BodyType<TalkDelegationInput>
    export type DelegateFromTalkMutationError = ErrorType<void>

    /**
 * @summary Queue a confirmed task from one agent to an authorized teammate
 */
export const useDelegateFromTalk = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof delegateFromTalk>>, TError,{agentId: string;data: BodyType<TalkDelegationInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof delegateFromTalk>>,
        TError,
        {agentId: string;data: BodyType<TalkDelegationInput>},
        TContext
      > => {
      return useMutation(getDelegateFromTalkMutationOptions(options));
    }
 ...
 */
export const getDocumentation = async ( options?: Parameters<typeof customFetch>[1]): Promise<Documentation> => {

  return customFetch<Documentation>(getGetDocumentationUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetDocumentationQueryOptions = <TData = Awaited<ReturnType<typeof getDocumentation>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDocumentation>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetDocumentationQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getDocumentation>>> = ({ signal }) => getDocumentation({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getDocumentation>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetDocumentation<TData = Awaited<ReturnType<typeof getDocumentation>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDocumentation>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetDocumentationQueryOptions(options)
...
export const getUpdateDocumentationSettingsUrl = () => {




  return `/api/documentation/settings`
}

/**
 * @summary Choose which Crustabot answers documentation questions
 */
export const updateDocumentationSettings = async (documentationSettingsInput: DocumentationSettingsInput, options?: Parameters<typeof customFetch>[1]): Promise<Documentation> => {

  return customFetch<Documentation>(getUpdateDocumentationSettingsUrl(),
  {
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(documentationSettingsInput)
  }
);}
...
export const getUpdateDocumentationSettingsMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateDocumentationSettings>>, TError,{data: BodyType<DocumentationSettingsInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateDocumentationSettings>>, TError,{data: BodyType<DocumentationSettingsInput>}, TContext> => {

const mutationKey = ['updateDocumentationSettings'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateDocumentationSettings>>, {data: BodyType<DocumentationSettingsInput>}> = (props) => {
          const {data} = props ?? {};

          return  updateDocumentationSettings(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateDocumentationSettingsMutationResult = NonNullable<Awaited<ReturnType<typeof updateDocumentationSettings>>>
    export type UpdateDocumentationSettingsMutationBody = BodyType<DocumentationSettingsInput>
    export type UpdateDocumentationSettingsMutationError = ErrorType<void>

    /**
 * @summary Choose which Crustabot answers documentation questions
 */
export const useUpdateDocumentationSettings = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateDocumentationSettings>>, TError,{data: BodyType<DocumentationSettingsInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updateDocumentationSettings>>,
        TError,
        {data: BodyType<DocumentationSettingsInput>},
        TContext
      > => {
      return useMutation(getUpdateDocumentationSettingsMutationOptions(options));
    }

export const getChatWithDocumentationUrl = () => {




  return `/api/documentation/chat`
}

/**
 * @summary Ask the selected guide Crustabot a question about Crustabox
 */
export const chatWithDocumentation = async (documentationChatInput: DocumentationChatInput, options?: Parameters<typeof customFetch>[1]): Promise<DocumentationChatResponse> => {

  return customFetch<DocumentationChatResponse>(getChatWithDocumentationUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(documentationChatInput)
  }
);}
...
export const getChatWithDocumentationMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof chatWithDocumentation>>, TError,{data: BodyType<DocumentationChatInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof chatWithDocumentation>>, TError,{data: BodyType<DocumentationChatInput>}, TContext> => {

const mutationKey = ['chatWithDocumentation'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof chatWithDocumentation>>, {data: BodyType<DocumentationChatInput>}> = (props) => {
          const {data} = props ?? {};

          return  chatWithDocumentation(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ChatWithDocumentationMutationResult = NonNullable<Awaited<ReturnType<typeof chatWithDocumentation>>>
    export type ChatWithDocumentationMutationBody = BodyType<DocumentationChatInput>
    export type ChatWithDocumentationMutationError = ErrorType<void>

    /**
 * @summary Ask the selected guide Crustabot a question about Crustabox
 */
export const useChatWithDocumentation = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof chatWithDocumentation>>, TError,{data: BodyType<DocumentationChatInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof chatWithDocumentation>>,
        TError,
        {data: BodyType<DocumentationChatInput>},
        TContext
      > => {
      return useMutation(getChatWithDocumentationMutationOptions(options));
    }
...
export const getRunScheduleNowUrl = (scheduleId: string,) => {




  return `/api/schedules/${scheduleId}/run`
}

/**
 * @summary Run a schedule immediately, once, without changing its saved cadence
 */
export const runScheduleNow = async (scheduleId: string, options?: Parameters<typeof customFetch>[1]): Promise<Schedule> => {

  return customFetch<Schedule>(getRunScheduleNowUrl(scheduleId),
  {
    ...options,
    method: 'POST'
...
export const getRunScheduleNowMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof runScheduleNow>>, TError,{scheduleId: string}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof runScheduleNow>>, TError,{scheduleId: string}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof runScheduleNow>>, {scheduleId: string}> = (props) => {
          const {scheduleId} = props ?? {};
...
export const getCreateTelegramLinkCodeUrl = () => {
  ...
  return `/api/telegram/link-code`
}

/**
 * @summary Create a short-lived one-time code for linking a Telegram chat
 */
export const createTelegramLinkCode = async (telegramLinkInput: TelegramLinkInput, options?: Parameters<typeof customFetch>[1]): Promise<TelegramLinkCode> => {
...
export const getCreateTelegramLinkCodeMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createTelegramLinkCode>>, TError,{data: BodyType<TelegramLinkInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createTelegramLinkCode>>, TError,{data: BodyType<TelegramLinkInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createTelegramLinkCode>>, {data: BodyType<TelegramLinkInput>}> = (props) => {
          const {data} = props ?? {};

          return  createTelegramLinkCode(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateTelegramLinkCodeMutationResult = NonNullable<Awaited<ReturnType<typeof createTelegramLinkCode>>>
    export type CreateTelegramLinkCodeMutationBody = BodyType<TelegramLinkInput>
    export type CreateTelegramLinkCodeMutationError = ErrorType<void>

    /**
 * @summary Create a short-lived one-time code for linking a Telegram chat
 */
export const useCreateTelegramLinkCode = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createTelegramLinkCode>>, TError,{data: BodyType<TelegramLinkInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getRemoveTelegramLinkUrl = () => {
 ...
 */
export const removeTelegramLink = async ( options?: Parameters<typeof customFetch>[1]): Promise<TelegramUnlinkResult> => {

  return customFetch<TelegramUnlinkResult>(getRemoveTelegramLinkUrl(),
  {
    ...options,
    method: 'DELETE'
...
export const getRemoveTelegramLinkMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof removeTelegramLink>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof removeTelegramLink>>, TError,void, TContext> => {

const mutationKey = ['removeTelegramLink'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof removeTelegramLink>>, void> = () => {


          return  removeTelegramLink(requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RemoveTelegramLinkMutationResult = NonNullable<Awaited<ReturnType<typeof removeTelegramLink>>>

    export type RemoveTelegramLinkMutationError = ErrorType<unknown>

    /**
 * @summary Unlink this workspace from Telegram and invalidate outstanding codes
 */
export const useRemoveTelegramLink = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof removeTelegramLink>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof removeTelegramLink>>,
        TError,
        void,
        TContext
      > => {
      return useMutation(getRemoveTelegramLinkMutationOptions(options));
    }
